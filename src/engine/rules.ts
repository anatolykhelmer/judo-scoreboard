/** IJF 2026-28 cycle. See docs/superpowers/specs/2026-08-26-judo-scoreboard-design.md section 3. */

export const OSAEKOMI_YUKO_MS = 5_000;
...
/** How often the panel dispatches TICK. */
